...
namespace VaultApplicationUnittestableUseCase
{
    /// <summary>
    ...
    public class VaultApplication : ConfigurableVaultApplicationBase<Configuration>
    {
        ...
        {
            var vaultMethods    = new VaultMethods(env.Vault);
            var useCase         = new AddModificationDateToTitleUseCase(vaultMethods);
