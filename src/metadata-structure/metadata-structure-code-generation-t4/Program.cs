...
namespace code_generation_t4
{
    internal class Program
    {
        ...
        private static string GeneratePropertyDefCode(Vault vault)
        {
        ...
        private static string GenerateClassCode(Vault vault)
        {
        ...
        private static Vault ConnectVault()
        {
